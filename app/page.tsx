  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-4 mt-8">
        ...
        {/* Subtítulo con Space Grotesk */}
        <span className="anim-subtitulo font-space font-bold text-xs sm:text-sm tracking-[0.25em] text-cyan-400 uppercase drop-shadow-[0_0_8px_rgba(34,211,238,0.4)]">
          Cada mesa tiene su oportunidad
        </span>

        {/* Título Principal con Orbitron */}
        <h1 className="anim-titulo font-orbitron font-black text-5xl sm:text-7xl md:text-8xl text-white uppercase tracking-wider leading-none">
          Las Vegas <br />
        ...
        {/* Descripción con Space Grotesk */}
        <p className="anim-descripcion font-space font-medium text-[15px] sm:text-base text-gray-300 max-w-md sm:max-w-xl leading-relaxed mt-2">
        ...
        <div className="relative w-full max-w-md mx-auto mt-6 px-4">
          ...
          {/* MENÚ DE BOTONES PRINCIPALES con Space Grotesk */}
          <div className="flex flex-col gap-4 w-full">
            <Link 
              href="/juegos" 
              className="anim-boton block w-full py-4 rounded-2xl font-space font-bold text-white text-base tracking-wide bg-gradient-to-r from-[#ff3ea5] to-[#9b5de5] shadow-[0_0_25px_rgba(255,62,165,0.45)] hover:shadow-[0_0_40px_rgba(255,62,165,0.7)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
            >
              Entrar a los Juegos
            </Link>
            ...
            <Link 
              href="/tu-cancion" 
              className="anim-boton block w-full py-4 rounded-2xl font-space font-medium text-gray-300 text-base tracking-wide bg-[#0f0b21]/90 border border-[#2b1b4b] hover:border-cyan-500 hover:text-white hover:shadow-[0_0_15px_rgba(34,211,238,0.3)] hover:scale-[1.01] active:scale-[0.99] transition-all duration-300"
            >
              Pedir una Canción
            </Link>
          ...
          {/* LEMA INFERIOR con Orbitron y Space Grotesk combinados */}
          <div className="mt-12 px-2">
            <p className="anim-lema-neon font-space font-bold text-xs sm:text-sm text-gray-200 uppercase tracking-widest">
              Descubre una nueva forma de farriar en{' '}
              <span className="contenedor-sopetran relative inline-block">
                <span className="anim-sopetran inline-block text-[#d41a7e] transition-all duration-75 select-none text-base font-orbitron font-black tracking-wider">
                  Sopetrán
                </span>
              </span>
            </p>
