...
export type JuegoId = 'ruleta' | 'ruleta-premios'| 'cajones' | 'barra_clicks' | 'sismografo' | 'trivia' | 'mesa-que-mas-aplauda';
...
export const JUEGOS_CONFIG: ConfigJuego[] = [
  ...
  { id: 'ruleta-premios', nombre: 'La Ruleta de Premios', tipo: 'por_mesa', icono: FerrisWheel },
